...
public class FullStackBackendApplication implements CommandLineRunner {
	...
	public void generatedData() {
		...
		iBusiness.saveHotel(new Hotel(null, "Hôtel de Crillon","Découvrez notre hôtel de luxe niché en bord de mer, offrant des vues imprenables, des suites somptueuses, une cuisine gastronomique et un spa indulgent. Profitez d'un service exceptionnel et d'instants mémorables dans un cadre paradisiaque.", "0554323457", "15 Rue des Lilas, 75020 Paris", 4, 12,10, 80, "hotel1.jpg", paris));
		iBusiness.saveHotel(new Hotel(null, "Le Bristol Paris", "Découvrez notre hôtel de luxe niché en bord de mer, offrant des vues imprenables, des suites somptueuses, une cuisine gastronomique et un spa indulgent. Profitez d'un service exceptionnel et d'instants mémorables dans un cadre paradisiaque.", "0559037457", "9 Avenue des artisans, 75020 Paris", 5, 8, 45, 160, "hotel2.jpg", paris));
		iBusiness.saveHotel(new Hotel(null, "L'Escapade Dorée", "Découvrez notre hôtel de luxe niché en bord de mer, offrant des vues imprenables, des suites somptueuses, une cuisine gastronomique et un spa indulgent. Profitez d'un service exceptionnel et d'instants mémorables dans un cadre paradisiaque.","0554326636", "14 Impasse de Bretagne, 75020 Paris", 3, 20,6, 45, "hotel3.jpg", paris));

		iBusiness.saveHotel(new Hotel(null, "Sofitel Vieux-Port", "Découvrez notre hôtel de luxe niché en bord de mer, offrant des vues imprenables, des suites somptueuses, une cuisine gastronomique et un spa indulgent. Profitez d'un service exceptionnel et d'instants mémorables dans un cadre paradisiaque.","0554326636", "9 rue du soleil, 13001 Marseille", 2, 20,12, 70, "hotel4.jpg", marseille));
		iBusiness.saveHotel(new Hotel(null, "Hôtel Ibis", "Découvrez notre hôtel de luxe niché en bord de mer, offrant des vues imprenables, des suites somptueuses, une cuisine gastronomique et un spa indulgent. Profitez d'un service exceptionnel et d'instants mémorables dans un cadre paradisiaque.","0551234636", "10 Place de la République, 13001 Marseille", 5, 5,23, 125, "hotel5.jpg", marseille));
		iBusiness.saveHotel(new Hotel(null, "Radisson Blu Hotel", "Découvrez notre hôtel de luxe niché en bord de mer, offrant des vues imprenables, des suites somptueuses, une cuisine gastronomique et un spa indulgent. Profitez d'un service exceptionnel et d'instants mémorables dans un cadre paradisiaque.","0554329809", "15 Quai des Belges, 13001 Marseille", 1, 30,44, 35, "hotel6.jpg", marseille));

		iBusiness.saveHotel(new Hotel(null, "Hôtel Palladia", "Découvrez notre hôtel de luxe niché en bord de mer, offrant des vues imprenables, des suites somptueuses, une cuisine gastronomique et un spa indulgent. Profitez d'un service exceptionnel et d'instants mémorables dans un cadre paradisiaque.","0554329876", "10 Rue de Metz, 31000 Toulouse", 1, 7, 5,85, "hotel7.jpg", toulouse));
		iBusiness.saveHotel(new Hotel(null, "Hôtel des Beaux Arts", "Découvrez notre hôtel de luxe niché en bord de mer, offrant des vues imprenables, des suites somptueuses, une cuisine gastronomique et un spa indulgent. Profitez d'un service exceptionnel et d'instants mémorables dans un cadre paradisiaque.","0554329547", "35 Rue du Taur, 31000 Toulouse", 5, 13,22, 190, "hotel8.jpg", toulouse));
		iBusiness.saveHotel(new Hotel(null, "Le Crowne Plaza", "Découvrez notre hôtel de luxe niché en bord de mer, offrant des vues imprenables, des suites somptueuses, une cuisine gastronomique et un spa indulgent. Profitez d'un service exceptionnel et d'instants mémorables dans un cadre paradisiaque.","0554453436", "18 Place du Capitole, 31000 Toulouse", 4, 20,155, 200, "hotel9.jpg", toulouse));
